...
;;;
;;; 12/28/90:
;;; Fixed a bug in the computation of the average value of the error.  It is
;;; important to keep a separate average for each output.
;;;
;;; 3/4/91:
;;; Turned compute-errors into a macro for better performance, especially in
;;; CMU Common Lisp.  This version not generally released.
;;;
;;; 5/11/91:
;;; Discovered that the 3/4 version fixed a bug that had been introduced
;;; earlier (in 12/28 release?), so released the newer version.  The bug
;;; made it impossible to run with *use-cache* off.
;;; ***************************************************************************
